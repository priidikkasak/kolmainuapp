...
export function InfoRow({
  ...
  return (
    <div className="grid grid-cols-[64px_1fr] items-baseline gap-3 px-[18px] py-[18px] bg-surface rounded-[14px]">
      ...
      <div
        className={`min-w-0 text-[15px] font-medium text-ink leading-[1.5] [overflow-wrap:anywhere] [&_a]:underline [&_a]:decoration-line-strong [&_a]:decoration-2 [&_a]:underline-offset-[5px] [&_a]:transition-opacity [&_a]:active:opacity-60 [&_a[target='_blank']]:after:content-['_↗'] [&_a[target='_blank']]:after:text-ink-3 ${
